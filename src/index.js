...
const paigam = {
  verificationEmailWithCodeV1,
  verificationEmailWithCodeV2,
  verificationEmailWithLinkV1,
  verificationEmailWithLinkV2,
  resetPasswordEmailV1,
  resetPasswordEmailV2,
  otpEmailV1,
  otpEmailV2,
  feedbackEmailV1,
  feedbackEmailV2,
