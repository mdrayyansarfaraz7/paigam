  ...
  const socialIcons = Object.entries(socialLinks)
    .map(
      ...
      <a href="${url}" style="margin:0 8px; display:inline-block;">
        <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/${name}.svg"
             alt="${name}" width="24" height="24" style="display:block; filter: invert(40%);">
      </a>
    `
    )
    .join("");
                      ...
                      <tr>
                          <td style="padding:48px 40px 40px 40px; text-align:center;">
                              ...
                              <h2 style="font-size:24px; color:#1a1a1a; font-weight:600; margin:0 0 18px 0;">
                                  Welcome to <span style="color:#2a7ae2;">${companyName}</span>
                              </h2>
                              <!-- Message -->
                              ...
                              <table border="0" cellspacing="0" cellpadding="0" align="center" style="margin:28px auto;">
                                  <tr>
                                      <td align="center">
                                          <a href="${ctaLink}" style="background-color:#2a7ae2; color:#ffffff; font-size:16px; font-weight:600; 
